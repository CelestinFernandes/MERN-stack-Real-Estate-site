      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex gap-6'>
            <input
              type='file' className='border p-3 rounded-lg'
              onChange={(e) => setFiles(e.target.files)}
              multiple
            />
            <button
              type='button' className='bg-blue-500 text-white p-3 rounded-lg'
            ...
            <div className='flex flex-col gap-2'>
              {formData.imageUrls.map((url, index) => (
                <div key={index} className='relative'>
                  <img src={url} alt={`upload-${index}`} className='w-40' />
                  <button
                    type='button'
          ...
          <button
            type='submit' className='bg-green-500 text-white p-3 rounded-lg'
            disabled={loading}
          >
